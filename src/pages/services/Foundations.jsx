...
export default function Foundations() {
  const HERO = '/images/foundationhero.jpeg'
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta property="og:url" content="https://www.bksconcrete.com/services/foundations" />
        <link rel="preload" as="image" href={HERO} />
      </Helmet>

      <section className="relative w-full h-[320px] md:h-[420px] lg:h-[480px]">
        <img src={HERO} alt="Concrete foundation pour in Concord NC" className="absolute inset-0 w-full h-full object-cover" loading="eager" fetchpriority="high" />
