  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Reliable foundation pours, footings, and slabs on grade for additions, shops, and new builds in the Concord NC area."
        />
        ...
        <meta property="og:image" content="/images-optimized/foundationhero.jpeg" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://blackknight.hometownwebco.com/services/foundations" />
        <link rel="preload" as="image" href="/images-optimized/foundationhero.jpeg" />
      ...
      <section className="relative w-full h-[320px] md:h-[420px] lg:h-[480px]">
        <img
          src="/images-optimized/foundationhero.jpeg"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-6 text-gray-700">
            ...
            <p>We focus on base prep, rebar placement, and pour timing to hit the strength and finish targets your project needs.</p>
          </div>
