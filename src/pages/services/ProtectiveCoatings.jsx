  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative w-full h-[320px] md:h-[420px] lg:h-[480px]">
        <img src={HERO} alt="Applying protective coating to a concrete floor" className="absolute inset-0 w-full h-full object-cover" loading="eager" fetchpriority="high" />
